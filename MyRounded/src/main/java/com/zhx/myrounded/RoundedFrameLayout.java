 ...
 *
 */
public class RoundedFrameLayout extends FrameLayout implements RoundMethodInterface {
    ...
    public RoundedFrameLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,-1);
    }

    public RoundedFrameLayout(Context context, @Nullable AttributeSet attrs,int defStyleAttr) {
